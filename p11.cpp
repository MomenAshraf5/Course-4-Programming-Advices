...
enum enAverageMark {Pass = 50, Fail = 49};
...
string CalcAverageMark(float average)
{
    if(average >= enAverageMark::Pass)
        return "Pass";
    else
        return "Fail";
}
...
void PrintSumOfNumbers(stNumbers numbers)
{
    ...
    string Mark = CalcAverageMark(AverageNumbers);
    ...
    string AvgMarkResult = "\nThe Mark of your average " + to_string(AverageNumbers) + " is " + Mark;
